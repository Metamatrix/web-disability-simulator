var data= {
  ...
  'dyslexia-listItems': ["Undvik text i liten storlek och långa texter. Se till att ha ordentligt med radavstånd.", 	
  ...
  'parkinsons-listItems': ["Se till att webbplatsen kan användas med andra hjälpmedel än mus, till exempel tangentbordsnavigering.", 	
  ...
  'yellowBlueColorBlindness-listItems': ["Använd inte färg som det enda sättet att förmedla information, indikera en handling eller identifiera ett element. Markera till exempel inte ett felaktigt formulärfält endast med en röd ram utan komplettera även med text och gärna en ikon.", 	
